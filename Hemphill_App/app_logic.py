# app_logic.py (Versión Final Corregida con Cierre Correcto)
...
class HemphillApp(tk.Tk):
    def __init__(self):
        ...
        # --- AÑADIR ESTA LÍNEA PARA MANEJAR EL CIERRE ---
        self.protocol("WM_DELETE_WINDOW", self.on_closing)  # <-- NUEVO
    ...
    def on_closing(self): # <-- NUEVO
        """Maneja el cierre de la ventana principal."""
        self.destroy() # Detiene el mainloop y cierra el programa limpiamente
